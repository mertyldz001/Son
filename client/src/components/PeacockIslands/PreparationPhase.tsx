    ...
    <div className="w-full h-full bg-gray-900 text-white p-4 flex flex-col">
      ...
      <div className="bg-gray-800 p-4 rounded-lg mb-4 flex justify-between items-center">
        <div className="flex flex-col">
          <h2 className="text-xl font-bold">Hazırlık Fazı</h2>
          <p className="text-sm text-gray-400">Kaynaklarınızı toplayın ve adanızı güçlendirin</p>
        </div>
        
        <div className="flex items-center gap-4">
          <div className="bg-purple-900 px-4 py-2 rounded-md flex items-center">
            <span className="material-icons mr-2">timer</span>
            <span className="font-bold">{preparationTimeLeft} saniye</span>
          </div>
          
          <div className="bg-yellow-800 px-4 py-2 rounded-md flex items-center">
      ...
      <div className="flex gap-4 h-full flex-1">
        ...
        <div className="w-1/3 bg-gray-800 rounded-lg p-4 flex flex-col">
          ...
          <div className="bg-gray-700 rounded-md p-3 flex-1">
            <h4 className="text-md font-semibold mb-2">Binalar</h4>
            <div className="space-y-2">
              {player.island.buildings.map(building => (
                <div key={building.id} className="bg-gray-800 p-2 rounded flex justify-between items-center">
                  <div>
        ...
        <div className="flex-1 bg-gray-800 rounded-lg p-4 flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            <button 
              className={`p-3 rounded-md text-left ${selectedAction === "collectFeathers" ? "bg-blue-900" : "bg-gray-700 hover:bg-gray-600"}`}
            ...
            <button 
              className={`p-3 rounded-md text-left ${selectedAction === "trainSoldiers" ? "bg-blue-900" : "bg-gray-700 hover:bg-gray-600"}`}
            ...
            <button 
              className={`p-3 rounded-md text-left ${selectedAction === "combineFeathers" ? "bg-blue-900" : "bg-gray-700 hover:bg-gray-600"}`}
            ...
            <button 
              className={`p-3 rounded-md text-left ${selectedAction === "hatchEgg" ? "bg-blue-900" : "bg-gray-700 hover:bg-gray-600"}`}
          ...
          {selectedAction === "collectFeathers" && (
            <div className="bg-gray-700 p-4 rounded-md">
              ...
              <button 
                className="bg-blue-700 hover:bg-blue-600 px-4 py-2 rounded w-full"
          ...
          <div className="bg-gray-700 rounded-md p-3 flex-1">
            ...
            <div className="space-y-2">
              {npc.island.buildings.map(building => (
                <div key={building.id} className="bg-gray-800 p-2 rounded">
                  <div className="font-medium">
                    {building.type === "barracks" && "Kışla"}
                    {building.type === "mine" && "Maden"}
                    {building.type === "hatchery" && "Kuluçka"}
