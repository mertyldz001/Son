      ...
      <div className="absolute inset-0 z-10 p-4 pointer-events-none">
        ...
        <div className="flex gap-4 h-3/4 pointer-events-auto">
          ...
          <div className="flex-1 glass-panel rounded-lg p-4 flex flex-col text-white">
            ...
            <div className="glass-panel bg-indigo-900/20 rounded-lg p-3 mb-4 border border-indigo-500/20">
              <div className="flex justify-between items-center mb-2">
                <h4 className="text-md font-semibold flex items-center">
                  <span className="material-icons mr-2 text-purple-400">location_city</span>
                  Binalarınız
                </h4>
                <button 
              ...
              {buildingSelected === "buildings" ? (
                <div>
                  <div className="glass-panel bg-slate-900/40 rounded-lg p-3 mb-3 border border-slate-600/20">
                    <p className="text-xs text-gray-300">
                      Binalarınızı geliştirebilir ve adanızın yeteneklerini artırabilirsiniz.
                      Her seviye yükseltme, binanın kapasitesini ve verimliliğini artırır.
                    </p>
                  </div>
                    ...
                    {player.island.buildings.map(building => (
                      <div 
                        ...
                        className={`p-4 rounded-lg ${
                          buildingSelected === building.id 
                          ? 'bg-indigo-900/50 border-2 border-indigo-500 shadow-lg shadow-indigo-900/30' 
                          : 'bg-gradient-to-br from-slate-800/80 to-slate-700/50 border border-slate-600/30 hover:border-indigo-500/50'
                        } cursor-pointer card-hover transition-all duration-300`}
                        onClick={() => {
                          playClick();
                      ...
                      >
                        <div className="flex flex-col items-center mb-3">
                          <div className={`w-14 h-14 rounded-full flex items-center justify-center mb-2 ${
                            building.type === "barracks" 
                              ? "bg-gradient-to-br from-red-800/80 to-red-700/50 border border-red-600/50" 
                              : building.type === "mine"
                              ? "bg-gradient-to-br from-yellow-800/80 to-yellow-700/50 border border-yellow-600/50"
                              : "bg-gradient-to-br from-purple-800/80 to-purple-700/50 border border-purple-600/50"
                          }`}>
                          ...
                          <div className="text-center">
                            <div className={`font-medium text-lg ${
                              building.type === "barracks" ? "text-red-300" : 
                              building.type === "mine" ? "text-yellow-300" : "text-purple-300"
                            }`}>
                              {building.type === "barracks" ? "Kışla" : 
                               building.type === "mine" ? "Maden" : "Kuluçkahane"}
                            </div>
                            <div className="bg-slate-800/70 text-slate-300 text-xs px-3 py-1 rounded-full border border-slate-700/50 flex items-center justify-center mt-1">
                        ...
                        <div className="text-xs text-center mt-2">
                          <span className={`inline-flex items-center px-3 py-1 rounded-full ${
                            ...
                            <span className="material-icons text-xs mr-1">
                              {building.type === "barracks" ? "bolt" : 
                               building.type === "mine" ? "paid" : "star"}
                            </span>
                            Üretim: {building.productionRate}/tur
                          </span>
                        </div>
                      </div>
                    ))}
